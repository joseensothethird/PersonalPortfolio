...
>
  Hi, I'm Jose C. Enso III | 호세 엔소 삼세 — a Full-Stack Web Developer skilled in React.js, Vue.js, WordPress, and Node.js. 
  ...
  <a className="" href="https://www.instagram.com/ensothethird/" target="_blank"rel="noreferrer noopener"><i className="fa-brands fa-square-instagram text-3xl ml-5"></i></a>
          ...
          <div className="teck-stack  flex sm:flex-col xl:flex-row items-center justify-between gap-2 xl:mt-0 sm:mt-10 ">
            ...
            <div className="tech-icons  transition grid sm:grid-cols-3 content-center justify-content-center xl:grid-cols-6 gap-5 xl:mt-0 sm:mt-0">
              ...
              <motion.div initial={{ opacity: 0, y: -50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1.3, type: 'spring', bounce: 0.4 }} className="w-[60px] bg-white shadow-xl rounded-full p-3 cursor-pointer"><img className="w-full h-full object-contain"src="https://cdn.worldvectorlogo.com/logos/next-js.svg" alt="Next.js"/></motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: -50 }} whileInView={{ opacity: 1, y: 0 }}transition={{ duration: 1.3, type: "spring", bounce: 0.4 }}className="w-[60px] bg-white shadow-xl rounded-full p-3 cursor-pointer"> <img   className="w-full h-full object-contain" src="https://logo.svgcdn.com/l/supabase-icon.svg" alt="Supabase"/></motion.div>
              <motion.div initial={{ opacity: 0, y: -50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, type: 'spring', bounce: 0.4 }} className="w-[60px] bg-white shadow-xl rounded-full p-3 cursor-pointer"> <img className="w-full h-full object-contain" src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/postgresql/postgresql-original.svg" alt="PostgreSQL" /></motion.div>
              ...
              <motion.div initial={{ opacity: 0, y: -50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1.5, type: 'spring', bounce: 0.4 }} className="w-[60px] bg-white shadow-xl rounded-full p-3 cursor-pointer "><img className="w-full h-full object-cover" src="/images/icons/ghl.jpeg" alt="GoHighLevel" /></motion.div>
          </div>
          </div>

        </motion.div>
        <div className="flex items-center justify-center">
          <motion.div initial={{ opacity: 0, x: 50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, }} className="rounded-full sm:w-[300px] xl:w-[300px]  relative"><img className="animate-blob w-full border border-slate-100 z-50 h-full object-cover"src="/images/personal/dp.jpg"alt=""/></motion.div>
        </div>
